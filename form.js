...
var p1 = new persona("Sandalias", "piso",575);	
...
function btn_listar()
{  
	var cadena ="<table class='tabla_formulario'> <tr><td> Producto</td> <td> Descripci&oacute;n</td> <td> Precio</td> <td colspan='2'> </td></tr> ";
	for (var i = 0; i < lista.length; i++) {
		cadena = cadena + "<tr><td>"+lista[i].nombre+"</td><td>"+lista[i].apellido+"</td><td>"+lista[i].edad+"</td>"+
		"<td> <button class='btn_editar' onclick='btn_editar("+i+");'> Actualizar </button> <button class='btn_eliminar' onclick='btn_eliminar()'> Eliminar </button></td></tr>";
	}
	cadena = cadena+"</table>"
